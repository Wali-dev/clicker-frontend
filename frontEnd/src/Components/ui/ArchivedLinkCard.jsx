...
const ArchivedLinkCard = (props) => {
    ...
    return (
        <div className="flex flex-col flex-wrap">
            <div className="bg-orange-300 m-2 mx-5 p-4 flex relative rounded-2xl ">
                <div>
                    <div>{link_title}</div>
                    <div className="text-wrap"><a href={actual_link}>{(actual_link.length > 50 ? actual_link.slice(0, 50) + '...' : actual_link)}</a></div>
                    <div className="text-wrap">Last updated : {updatedAt.slice(0, 10)}</div>
                </div>
                <div className="flex absolute right-2 ">
                    <div className="hover:bg-green-600 rounded" onClick={() => {
                    ...
                    <div className="hover:bg-red-600 rounded ml-1" onClick={() => {
